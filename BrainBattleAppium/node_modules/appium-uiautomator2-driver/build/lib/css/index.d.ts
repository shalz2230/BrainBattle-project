import type { NativeLocator } from '@appium/css-locator-to-native';
 ...
 */
export declare function cssToNativeLocator(css: string, appPackage?: string | null): Promise<NativeLocator>;
