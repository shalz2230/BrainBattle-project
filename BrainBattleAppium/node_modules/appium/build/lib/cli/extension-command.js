...
class ExtensionCliCommand {
    ...
    async _doctor({ installSpec }) {
        ...
        const checks = lodash_1.default.flatMap((await Promise.all(loadChecksPromises)).filter(Boolean).map(lodash_1.default.toPairs))
            .map(([, value]) => value)
    ...
    async _addRepositoryUrlsToListData(listData) {
        await (0, utils_1.spinWith)(this.isJsonOutput, 'Fetching repository information', async () => {
            await (0, asyncbox_1.asyncmap)(lodash_1.default.values(listData), async (data) => {
