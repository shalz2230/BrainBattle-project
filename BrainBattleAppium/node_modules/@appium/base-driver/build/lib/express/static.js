...
exports.STATIC_DIR = resolveStaticDir();
...
async function getTemplate(templateName) {
    ...
    return (0, utils_1.compileLodashTemplate)(content.toString());
}
function resolveStaticDir() {
    ...
    return node_path_1.default.join(parts.slice(0, baseDriverIndex + 1).join(node_path_1.default.sep), 'static');
}
